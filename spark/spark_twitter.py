...
if __name__ == "__main__":
    ...
    tweets = tweets.withColumnRenamed("id", "tweet_id") \
    ...
    rt_df = tweets \
        .select("tweet_id", "retweeted_status.id","retweeted_status.text","retweeted_status.user") \
    ...
    final_df = user_df.join(rt_df, (user_df.tweet_id == rt_df.tweet_id) & (user_df.tweet_id == rt_df.tweet_id))
